...
log "Importing historical OKR data for T5-T6/2026"
{compose} exec -T backend python scripts/import_historical.py /app/KHMT_Monthly --months 5 6 --imported-by deploy-import
