...
class TeamReportModel(Base):
    ...
    report_month: Mapped[int | None] = mapped_column(Integer)
...
class WarningModel(Base):
    ...
    id: Mapped[str] = mapped_column(String, primary_key=True)
    team_report_id: Mapped[str | None] = mapped_column(String)
...
class SKCTKTModel(Base):
    ...
    khmt_month: Mapped[int | None] = mapped_column(Integer)
    khmt_year: Mapped[int | None] = mapped_column(Integer)
    is_public: Mapped[bool] = mapped_column(Boolean, default=False)
    is_counted_for_okr: Mapped[bool] = mapped_column(Boolean, default=False)
    is_historical_import: Mapped[bool] = mapped_column(Boolean, default=False)
...
class NotificationModel(Base):
    ...
    id: Mapped[str] = mapped_column(String, primary_key=True)
    recipient_role: Mapped[str | None] = mapped_column(String)
    recipient_user_id: Mapped[str | None] = mapped_column(String)
